...
export default function AcceptInviteForm({form, onSubmit, submitting}: SignUpFormProps) {
					...
					<div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2 ">
						...
						<div className="col-span-2">
							<FormField
								...
								name="email"
								render={({field}) => (
									<FormInputWrapper label={"Email"} description={"Must be the email address your invitation was sent to"}>
										<Input {...field} className={'h-10'}/>
									</FormInputWrapper>
								)}
							/>
